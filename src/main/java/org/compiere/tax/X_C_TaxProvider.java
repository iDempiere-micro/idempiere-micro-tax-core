...
public class X_C_TaxProvider extends PO implements I_C_TaxProvider, I_Persistent {
  ...
  public void setC_TaxProviderCfg_ID(int C_TaxProviderCfg_ID) {
    if (C_TaxProviderCfg_ID < 1) set_Value(COLUMNNAME_C_TaxProviderCfg_ID, null);
    else set_Value(COLUMNNAME_C_TaxProviderCfg_ID, Integer.valueOf(C_TaxProviderCfg_ID));
  }
  ...
  public void setC_TaxProvider_ID(int C_TaxProvider_ID) {
    if (C_TaxProvider_ID < 1) set_ValueNoCheck(COLUMNNAME_C_TaxProvider_ID, null);
    else set_ValueNoCheck(COLUMNNAME_C_TaxProvider_ID, Integer.valueOf(C_TaxProvider_ID));
  }
